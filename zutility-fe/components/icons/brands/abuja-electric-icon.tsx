...
const AbujaElectricIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
AbujaElectricIcon.displayName = "AbujaElectricIcon";
export default AbujaElectricIcon;
