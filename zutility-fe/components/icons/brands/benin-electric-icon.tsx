...
const BeninElectricIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
BeninElectricIcon.displayName = "BeninElectricIcon";
export default BeninElectricIcon;
