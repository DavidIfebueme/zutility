...
const KadunaElectricIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
KadunaElectricIcon.displayName = "KadunaElectricIcon";
export default KadunaElectricIcon;
