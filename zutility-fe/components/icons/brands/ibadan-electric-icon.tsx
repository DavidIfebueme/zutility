...
const IbadanElectricIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
IbadanElectricIcon.displayName = "IbadanElectricIcon";
export default IbadanElectricIcon;
