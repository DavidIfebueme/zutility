...
fn runtime_network_policy_enforces_testnet_for_dev_and_staging() {
    let dev_mainnet = AppConfig {
        ...
        remita_merchant_id: None,
        remita_api_key: None,
        remita_service_type_id: None,
        remita_base_url: None,
        remita_webhook_secret: None,
        inlomax_api_key: None,
        inlomax_base_url: None,
        inlomax_webhook_secret: None,
        zcash_backend: crate::config::ZcashBackend::Rpc,
        zingo_indexer_uri: String::new(),
        zingo_wallet_dir: String::new(),
