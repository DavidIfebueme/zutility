...
const EnuguElectricIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
EnuguElectricIcon.displayName = "EnuguElectricIcon";
export default EnuguElectricIcon;
