...
const AirtelIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    const stop = useCallback(() => {
      animate(".airtel-swoosh", { scale: 1, rotate: 0 }, { duration: 0.2 });
    }, [animate]);
...
AirtelIcon.displayName = "AirtelIcon";
